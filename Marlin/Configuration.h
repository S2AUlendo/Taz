...
#define LULZBOT_FW_VERSION "2.1.3.0.0"
...
#ifdef FXDTICTRL
  #define FXDTICTRL_SHAPING_ZETAX 0.89f                           // Zeta used by input shapers.
  #define FXDTICTRL_SHAPING_ZETAY 0.31f                           // Zeta used by input shapers.
  #define FXDTICTRL_SHAPING_V_TOL_X 0.01f                         // Vibration tolerance used by EI input shapers.
  #define FXDTICTRL_SHAPING_V_TOL_Y 0.01f                         // Vibration tolerance used by EI input shapers.
#endif